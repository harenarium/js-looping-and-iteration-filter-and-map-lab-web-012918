...
function driversWithRevenueOver(drivers, revenue){
  return drivers.filter(function(driver){return driver.revenue > parseInt(revenue)})
}
...
function exactMatch(drivers, object){
 ...
 // - This function takes an array of driver objects as the first argument and a
 // JavaScript object that specifies an attribute and corresponding value.
 // For example, exactMatch(drivers, { revenue: 3000 }) will return all drivers whose revenue attribute equals 3000,
